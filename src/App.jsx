...
function Login({ onLogin }) {
  ...
  return (
    <div className="min-h-screen bg-[#0d0f12] text-white flex items-center justify-center p-4 font-sans">
      <div className="bg-[#14181d] border border-gray-800 p-8 rounded-3xl w-full max-w-md space-y-6 shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
          {filtered.map((item, idx) => (
            <div key={idx} className={`p-4 rounded-xl border flex flex-col justify-between ${bgInput}`}>
              ...
              <span className="text-sm font-black text-white my-1">{item.size}</span>
  ...
  return (
    <div className="space-y-4 text-xs">
      <div className="flex justify-between items-center">
        ...
        <div className={`flex items-center gap-3 border p-1.5 rounded-xl ${bgCard}`}>
      ...
      <div className={`border p-5 rounded-2xl space-y-4 ${bgCard}`}>
        <div className="grid grid-cols-7 gap-2 text-center font-bold text-[10px] uppercase text-gray-400">
            ...
            return (
              ...
              >
                <div className="flex justify-between items-center">
                  ...
                  {isToday ? <span className="text-[9px] bg-amber-400 text-black px-1.5 py-0.5 rounded font-black">TODAY</span> : null}
                </div>
    ...
    <div className="space-y-4 text-xs">
      ...
      <div className={`border p-5 rounded-2xl space-y-4 ${bgCard}`}>
        ...
        <form onSubmit={(e) => { e.preventDefault(); alert('Stock Added Successfully!'); }} className="space-y-3">
          ...
          <button type="submit" className="bg-amber-400 text-black font-black px-5 py-2.5 rounded-xl cursor-pointer hover:bg-yellow-500 transition-all uppercase tracking-wider">
            Save Stock Entry
          </button>
        </form>
      </div>
...
export default function App() {
  ...
  return (
    <div className={`flex min-h-screen font-sans ${bgMain}`}>
      <Sidebar 
        activeTab={activeTab} 
      ...
      <main className="flex-1 p-6 overflow-y-auto">
        ...
        {activeTab === 'Stock / Inventory' && (
          <div className="space-y-4 text-xs">
            ...
            <div className={`border p-5 rounded-xl space-y-3 ${bgCard}`}>
              ...
              <div className="space-y-2">
                <div className={`p-3 rounded-lg border flex justify-between ${bgInput}`}><span>10x15 Style 01 Frame Molding</span><span className="text-red-500 font-bold">2 Units Remaining</span></div>
                <div className={`p-3 rounded-lg border flex justify-between ${bgInput}`}><span>12x18 Style 02 Frame Molding</span><span className="text-amber-500 font-bold">5 Units Remaining</span></div>
              </div>
            </div>
          </div>
        )}
        ...
        {activeTab === 'Customers' && (
          <div className="space-y-4 text-xs">
            ...
            <div className={`border p-5 rounded-xl space-y-3 ${bgCard}`}>
              ...
              <div className={`p-3 rounded-lg border flex justify-between ${bgInput}`}><div><p className="font-bold">Hirun</p><p className="text-[10px] text-gray-400">0781149719</p></div><span className="text-amber-500 font-bold">1 Active Order</span></div>
            </div>
          </div>
        )}
